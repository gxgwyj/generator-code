...
import com.xyz.generator.config.*;
import com.xyz.generator.internal.rules.ConditionalModelRules;
import com.xyz.generator.internal.rules.FlatModelRules;
import com.xyz.generator.internal.rules.HierarchicalModelRules;
import com.xyz.generator.internal.rules.Rules;
...
public abstract class IntrospectedTable {
    ...
    public IntrospectedTable(TargetRuntime targetRuntime) {
        ...
        primaryKeyColumns = new ArrayList<com.xyz.generator.api.IntrospectedColumn>();
        baseColumns = new ArrayList<com.xyz.generator.api.IntrospectedColumn>();
        blobColumns = new ArrayList<com.xyz.generator.api.IntrospectedColumn>();
     ...
     * @return the column
     */
    public com.xyz.generator.api.IntrospectedColumn getColumn(String columnName) {
        if (columnName == null) {
            return null;
        } else {
            // search primary key columns
            for (com.xyz.generator.api.IntrospectedColumn introspectedColumn : primaryKeyColumns) {
            ...
            // search base columns
            for (com.xyz.generator.api.IntrospectedColumn introspectedColumn : baseColumns) {
                if (introspectedColumn.isColumnNameDelimited()) {
                    if (introspectedColumn.getActualColumnName().equals(
                            columnName)) {
                        return introspectedColumn;
            ...
            // search blob columns
            for (com.xyz.generator.api.IntrospectedColumn introspectedColumn : blobColumns) {
                if (introspectedColumn.isColumnNameDelimited()) {
                    if (introspectedColumn.getActualColumnName().equals(
                            columnName)) {
                        return introspectedColumn;
     ...
     */
    public List<com.xyz.generator.api.IntrospectedColumn> getPrimaryKeyColumns() {
     ...
     */
    public List<com.xyz.generator.api.IntrospectedColumn> getBaseColumns() {
        return baseColumns;
    }
     ...
     */
    public List<com.xyz.generator.api.IntrospectedColumn> getAllColumns() {
        List<com.xyz.generator.api.IntrospectedColumn> answer = new ArrayList<com.xyz.generator.api.IntrospectedColumn>();
     ...
     */
    public List<com.xyz.generator.api.IntrospectedColumn> getNonBLOBColumns() {
        List<com.xyz.generator.api.IntrospectedColumn> answer = new ArrayList<com.xyz.generator.api.IntrospectedColumn>();
        answer.addAll(primaryKeyColumns);
        answer.addAll(baseColumns);
     ...
     */
    public List<com.xyz.generator.api.IntrospectedColumn> getNonPrimaryKeyColumns() {
        List<com.xyz.generator.api.IntrospectedColumn> answer = new ArrayList<com.xyz.generator.api.IntrospectedColumn>();
        answer.addAll(baseColumns);
        answer.addAll(blobColumns);
     ...
     */
    public List<com.xyz.generator.api.IntrospectedColumn> getBLOBColumns() {
        return blobColumns;
    }
     ...
     */
    public void addColumn(com.xyz.generator.api.IntrospectedColumn introspectedColumn) {
    ...
    public void addPrimaryKeyColumn(String columnName) {
        ...
        Iterator<com.xyz.generator.api.IntrospectedColumn> iter = baseColumns.iterator();
        while (iter.hasNext()) {
            com.xyz.generator.api.IntrospectedColumn introspectedColumn = iter.next();
